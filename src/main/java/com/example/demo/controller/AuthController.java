...
public class AuthController {
    ...
    public ResponseEntity<?> login(@RequestBody LoginRequest request, HttpServletRequest httpRequest) {
        ...
        try {
            ...
            return ResponseEntity.ok(new UserProfileDTO(userOptional.get(), userOptional.get().getUserProfile()));
        } catch (Exception e) {
    ...
    public ResponseEntity<?> getCurrentUser(Authentication authentication, HttpServletRequest request) {
        ...
        return ResponseEntity.ok(new UserProfileDTO(user, user.getUserProfile()));
    }
    ...
    public ResponseEntity<?> getProfile(@RequestParam String email) {
        ...
        try {
            ...
            if (profile == null) {
                ...
                String userType = roleNames.contains("Member") ? "Member" :
                        roleNames.contains("Staff") ? "Staff" :
                                roleNames.contains("Consultant") ? "Consultant" :
                                        roleNames.contains("Manager") ? "Manager" :
                                                roleNames.contains("Admin") ? "Admin" : "Guest";
    ...
    public ResponseEntity<?> register(@Valid @RequestBody RegisterRequest request, BindingResult bindingResult) {
        ...
        try {
            ...
            Role userRole = roleRepository.findByRoleName("Member")
                    .orElseGet(() -> roleRepository.save(new Role(null, "Member", "Thành viên đã đăng ký")));
